...
import 'screens/profile/kisi_profil_ekrani.dart';
...
class CampusHubApp extends StatelessWidget {
  ...
  static final ValueNotifier<String> userTypeNotifier = ValueNotifier(
    'student',
  );
      ...
      builder: (context, _) {
        return MaterialApp(
          ...
          darkTheme: ThemeData(
            ...
            ), // GECE MENÜ RENGİ (Hayalet sorununun çözümü!)
          ...
          routes: {
            ...
            '/person-profile': (context) => const KisiProfilEkrani(),
