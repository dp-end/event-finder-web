...
class SolYanMenu extends StatelessWidget {
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            if (isClub) {
                              final clubId = user?['clubId']?.toString();
                              Navigator.pushNamed(
                                context,
                                '/club-profile',
                                arguments: {
                                  if (clubId != null && clubId.isNotEmpty) 'clubId': clubId,
                                  'kulupAdi': fullName.isNotEmpty ? fullName : 'Kulubum',
                                },
                              );
                            } else {
  ...
  Future<int> _unreadCount() async {
    ...
    try {
      final result = await ApiClient.get('/Notifications/unread-count') as Map<String, dynamic>;
