...
namespace CleanArchitecture.Infrastructure.Contexts
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Student>(e => e.ToTable("Students"));
            ...
            builder.Entity<Event>(entity =>
            {
                ...
                entity.Property(e => e.ClubId).HasMaxLength(255);
            ...
            builder.Entity<Ticket>(entity =>
            {
                ...
                entity.Property(t => t.ApplicationUserId).HasMaxLength(255);
            ...
            builder.Entity<Comment>(entity =>
            {
                ...
                entity.Property(c => c.ApplicationUserId).HasMaxLength(255);
            ...
            builder.Entity<EventLike>(entity =>
            {
                ...
                entity.Property(l => l.ApplicationUserId).HasMaxLength(255);
            ...
            builder.Entity<ClubFollower>(entity =>
            {
                ...
                entity.Property(f => f.ClubId).HasMaxLength(255);
                entity.Property(f => f.ApplicationUserId).HasMaxLength(255);
            ...
            builder.Entity<Notification>(entity =>
            {
                ...
                entity.Property(n => n.ApplicationUserId).HasMaxLength(255).IsRequired();
                entity.Property(n => n.RelatedClubId).HasMaxLength(255);
